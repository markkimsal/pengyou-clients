 ...
 * $Header$
 * $Revision: 208421 $
 * $Date: 2005-01-14 22:09:56 +0800 (Fri, 14 Jan 2005) $
 *
 * ====================================================================
 *
...
public class ReportMethod extends XMLResponseMethodBase
    ...
    /**
     * Report type: <code>DAV:version-tree</code> with a certain set of properties.
     */
    public static final int SUB_SET = 0;

    /**
     * Report type: <code>DAV:version-tree</code> with <code>DAV:allprop</code>. 
     */
    public static final int ALL = 1;

    /**
     * Report type: <code>DAV:locate-by-history</code>.
     * @see {@link #setHistoryURLs(Enumeration)}.
     */
    public static final int LOCATE_HISTORY = 2;

    /**
     * The <code>D:version-history-set</code> element for the 
     * <code>DAV:locate-by-history</code> report. 
     */
    private String sVersionHistory ="";
    /**
     * The request body provided in ctor.
     */
...
/**
    ...
    public void setPropertyNames(Enumeration propertyNames) {
        ...
        if (this.type == ALL) this.type = SUB_SET;
    }
    ...
    public void setHistoryURLs(Enumeration historyURLs) {
        ...
        buffer.append("<D:version-history-set>");

        while (historyURLs.hasMoreElements()) {
            buffer.append("<D:href>")
                  .append(historyURLs.nextElement().toString())
                  .append("</D:href>");
        }
        buffer.append("</D:version-history-set>");
        
        sVersionHistory = buffer.toString();
    }
